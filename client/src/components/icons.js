...
function ChevronLeftIcon () {
  return (
    ...
    >
      <path fill="#D3D3D3" d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/>
...
function ChevronRightIcon () {
  return (
    <svg
      ...
      className="nav-chevron"
    >
      <path fill="#D3D3D3" d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/>
      <path d="M0 0h24v24H0z" fill="none"/>
    </svg>
  )
}
...
function ResetIcon (props) {
  return (
    <svg
      ...
      className="dash-icon filter-icons"
    >
      <path fill="#D3D3D3" d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/>
      <path d="M0 0h24v24H0z" fill="none"/>
    </svg>
  );
}
...
function RewindIcon () {
  return (
    <svg
      ...
      className="nav-icon"
    >
      <path fill="#D3D3D3" d="M11 18V6l-8.5 6 8.5 6zm.5-6l8.5 6V6l-8.5 6z"/>
    </svg>
  );
}
